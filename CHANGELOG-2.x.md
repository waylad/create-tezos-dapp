...
- `babel-plugin-named-asset-import`, `babel-preset-react-app`, `react-dev-utils`, `react-error-overlay`, `tezos-scripts`
...
- `confusing-browser-globals`, `react-dev-utils`, `react-error-overlay`, `tezos-scripts`
  - [#5032](https://github.com/waylad/create-tezos-dapp/pull/5032) Upgrade `tezos-scripts` dependencies ([@Timer](https://github.com/Timer))
- `react-dev-utils`, `react-error-overlay`, `tezos-scripts`
  - [#5026](https://github.com/waylad/create-tezos-dapp/pull/5026) Switch from uglifyjs to terser ([@Timer](https://github.com/Timer))
- `create-tezos-dapp`
