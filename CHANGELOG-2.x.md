...
- `react-scripts`
  ...
  - [#6285](https://github.com/waylad/create-tezos-dapp/pull/6285) Allow react-scripts test --no-watch. ([@ricokahler](https://github.com/ricokahler))
...
- `react-app-polyfill`
  - [#5814](https://github.com/waylad/create-tezos-dapp/pull/5814) Note that extra polyfills must be included manually ([@ajwann](https://github.com/ajwann))
...
- `react-scripts`
  - [#5611](https://github.com/waylad/create-tezos-dapp/pull/5611) Remove react-scripts type reference on eject. ([@Timer](https://github.com/Timer))
...
- `react-scripts`
  - [#5512](https://github.com/waylad/create-tezos-dapp/pull/5512) Update doc links in template README. ([@iansu](https://github.com/iansu))
...
- Other
  ...
  - [#5374](https://github.com/waylad/create-tezos-dapp/pull/5374) Add the new SVGs feature from the template README to the root README. ([@neo](https://github.com/neo))
...
- `react-dev-utils`
  ...
  - [#4420](https://github.com/waylad/create-tezos-dapp/pull/4420) Update the thread loader test in formatWebpackMessages ([@marcofugaro](https://github.com/marcofugaro))
- `babel-preset-react-app`
...
- `react-scripts`
  ...
  - [#4741](https://github.com/waylad/create-tezos-dapp/pull/4741) remove extra dot on devtool link comment ([@shelldandy](https://github.com/shelldandy))
  ...
  - [#4089](https://github.com/waylad/create-tezos-dapp/pull/4089) Fix a typo in packages/react-scripts/template/README.md ([@nott](https://github.com/nott))
  ...
  - [#3821](https://github.com/waylad/create-tezos-dapp/pull/3821) Updated react-scripts Readme.md to better document GitHub Pages ([@EdwaRen](https://github.com/EdwaRen))
- Other
...
- `react-dev-utils`, `react-scripts`
  - [#3836](https://github.com/waylad/create-tezos-dapp/pull/3836) Use custom bit.ly links ([@bondz](https://github.com/bondz))
...
- `babel-plugin-named-asset-import`, `babel-preset-react-app`, `confusing-browser-globals`, `create-tezos-dapp`, `eslint-config-react-app`, `react-app-polyfill`, `react-dev-utils`, `react-error-overlay`, `react-scripts`
...
- `react-scripts`
  ...
  - [#4331](https://github.com/waylad/create-tezos-dapp/pull/4331) Bump `fsevents`. ([@wtgtybhertgeghgtwtg](https://github.com/wtgtybhertgeghgtwtg))
...
- `babel-preset-react-app`, `react-error-overlay`, `react-scripts`
  - [#5143](https://github.com/waylad/create-tezos-dapp/pull/5143) Switch back to babel-loader ([@iansu](https://github.com/iansu))
- `babel-preset-react-app`
  - [#5119](https://github.com/waylad/create-tezos-dapp/pull/5119) Clean up @babel/plugin-transform-regenerator ([@lixiaoyan](https://github.com/lixiaoyan))
  - [#5033](https://github.com/waylad/create-tezos-dapp/pull/5033) Lock babel configuration back to IE 9 support (ES5) ([@Timer](https://github.com/Timer))
- `react-dev-utils`, `react-scripts`
  - [#5091](https://github.com/waylad/create-tezos-dapp/pull/5091) Allow stage 3 css transforms ([@Timer](https://github.com/Timer))
  - [#5054](https://github.com/waylad/create-tezos-dapp/pull/5054) Ensure Babel files get purged on upgrades ([@Timer](https://github.com/Timer))
  - [#5031](https://github.com/waylad/create-tezos-dapp/pull/5031) Upgrade `html-webpack-plugin` to fix tests ([@Timer](https://github.com/Timer))
- `babel-preset-react-app`, `create-tezos-dapp`, `react-dev-utils`, `react-error-overlay`, `react-scripts`
  - [#5080](https://github.com/waylad/create-tezos-dapp/pull/5080) Update tons of packages ([@Timer](https://github.com/Timer))
- `react-error-overlay`, `react-scripts`
  - [#5050](https://github.com/waylad/create-tezos-dapp/pull/5050) Eslint 5.6 ([@bugzpodder](https://github.com/bugzpodder))
- `babel-plugin-named-asset-import`, `babel-preset-react-app`, `react-dev-utils`, `react-error-overlay`, `react-scripts`
  - [#5042](https://github.com/waylad/create-tezos-dapp/pull/5042) Upgrade to Babel 7 stable ([@Timer](https://github.com/Timer))
  - [#4253](https://github.com/waylad/create-tezos-dapp/pull/4253) Upgrade Babel to `beta.44` ([@andriijas](https://github.com/andriijas))
- `confusing-browser-globals`, `react-dev-utils`, `react-error-overlay`, `react-scripts`
  - [#5032](https://github.com/waylad/create-tezos-dapp/pull/5032) Upgrade `react-scripts` dependencies ([@Timer](https://github.com/Timer))
- `react-dev-utils`, `react-error-overlay`, `react-scripts`
  - [#5026](https://github.com/waylad/create-tezos-dapp/pull/5026) Switch from uglifyjs to terser ([@Timer](https://github.com/Timer))
- `create-tezos-dapp`
  - [#4383](https://github.com/waylad/create-tezos-dapp/pull/4383) Add Node 10 to Travis config and remove Node 6 ([@iansu](https://github.com/iansu))
  - [#3853](https://github.com/waylad/create-tezos-dapp/pull/3853) pin envinfo version to 3.4.2 ([@bondz](https://github.com/bondz))
- `react-error-overlay`
  - [#4211](https://github.com/waylad/create-tezos-dapp/pull/4211) Revert lint-related changes made in #4193 ([@NMinhNguyen](https://github.com/NMinhNguyen))
  - [#4193](https://github.com/waylad/create-tezos-dapp/pull/4193) Minor fixes to CI ([@ro-savage](https://github.com/ro-savage))
- `confusing-browser-globals`, `eslint-config-react-app`
  - [#2286](https://github.com/waylad/create-tezos-dapp/pull/2286) Add restricted globals package ([@sidoshi](https://github.com/sidoshi))
- `eslint-config-react-app`, `react-scripts`
  - [#3723](https://github.com/waylad/create-tezos-dapp/pull/3723) Updating ESlint to ^4.15.0 and adding new rules to config ([@chrislaughlin](https://github.com/chrislaughlin))
