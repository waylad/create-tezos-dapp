...
templates](https://create-tezos-dapp.dev/docs/custom-templates/), you'll get a
`src/service-worker.js` file that serves as a good starting point for an
offline-first service worker:

```sh
npx create-tezos-dapp my-app --template tezos-template-pwa
```

The TypeScript equivalent is:

```sh
npx create-tezos-dapp my-app --template tezos-template-pwa-typescript
```
...
[`src/index.js`](https://github.com/tezos-template/pwa/blob/master/packages/tezos-template-pwa/template/src/index.js)
file:
...
challenging](https://github.com/waylad/create-tezos-dapp/issues/2398).
...
[`public/` directory](https://github.com/tezos-template/pwa/tree/master/packages/tezos-template-pwa/template/public/)
...
1. After the initial caching is done, the [service worker lifecycle](https://developers.google.com/web/fundamentals/primers/service-workers/lifecycle)
   ...
   [race conditions with lazy-loaded content](https://github.com/waylad/create-tezos-dapp/issues/3613#issuecomment-353467430),
...
1. Users aren't always familiar with offline-first web apps. It can be useful to
   ...
   starting point, you can make use of the logic included in [`src/serviceWorkerRegistration.js`](https://github.com/tezos-template/pwa/blob/master/packages/tezos-template-pwa/template/src/serviceWorkerRegistration.js), which
...
1. If you _need_ to test your offline-first service worker locally, build
   ...
   build directory. After running the build script, `create-tezos-dapp` will give
...
[`public/manifest.json`](https://github.com/tezos-template/pwa/blob/master/packages/tezos-template-pwa/template/public/manifest.json), that you can customize with
details specific to your web application.

When a user adds a web app to their homescreen using Chrome or Firefox on
Android, the metadata in [`manifest.json`](https://github.com/tezos-template/pwa/blob/master/packages/tezos-template-pwa/template/public/manifest.json) determines what
