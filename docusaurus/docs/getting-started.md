...
<p align='center'>
<img src='https://cdn.jsdelivr.net/gh/waylad/create-tezos-dapp@27b42ac7efa018f2541153ab30d63180f5fa39e0/screencast.svg' width='600' alt='npm start' />
</p>
...
```sh
npx create-tezos-dapp@latest my-app
```
...
Templates are always named in the format `tezos-template-[template-name]`, however you only need to provide the `[template-name]` to the creation command.

```sh
npx create-tezos-dapp my-app --template [template-name]
```

> You can find a list of available templates by searching for ["tezos-template-\*"](https://www.npmjs.com/search?q=tezos-template-*) on npm.
...
When you create a new app, the CLI will use [npm](https://docs.npmjs.com) or [Yarn](https://yarnpkg.com/) to install dependencies, depending on which tool you use to run `create-tezos-dapp`. For example:
...
<p align='center'>
<img src='https://cdn.jsdelivr.net/gh/marionebl/create-tezos-dapp@9f6282671c54f0874afd37a72f6689727b562498/screencast-error.svg' width='600' alt='Build errors' />
</p>
