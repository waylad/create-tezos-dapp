...
For example, support in Internet Explorer requires a [polyfill](https://github.com/waylad/create-tezos-dapp/blob/main/packages/react-app-polyfill/README.md).
