...
Recent versions of [Flow](https://flow.org/) work with Create Tezos Dapp projects out of the box.

To add Flow to a Create Tezos Dapp project, follow these steps:
