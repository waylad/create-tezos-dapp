# Contributing to Create Tezos Dapp's E2E tests
...
These tests are run by **jest** and the environment is `test`, so that it resembles how a **Create Tezos Dapp** application is tested.
