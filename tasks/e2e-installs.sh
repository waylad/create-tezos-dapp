...
cd "$temp_app_path"
npx create-tezos-dapp test-app-dist-tag --scripts-version=@latest
...
cd "$temp_app_path"
npx create-tezos-dapp test-app-version-number --scripts-version=1.0.17
...
cd "$temp_app_path"
npx create-tezos-dapp test-app-typescript --template typescript
...
npx create-tezos-dapp test-app-should-not-exist --scripts-version=`date +%s` || true
...
# we will install a non-existing package to simulate a failed installation.
npx create-tezos-dapp test-app-should-remain --scripts-version=`date +%s` || true
...
npx create-tezos-dapp test-app-nested-paths-t1/aa/bb/cc/dd
cd test-app-nested-paths-t1/aa/bb/cc/dd
npm start -- --smoke-test

# Testing a path that does not exist
cd "$temp_app_path"
npx create-tezos-dapp test-app-nested-paths-t2/aa/bb/cc/dd
...
npx create-tezos-dapp test-app-nested-paths-t3/aa/bb/cc/dd
